    ...
    if sv_positions.empty:
        ...
        st.markdown(
            ...
            <div class="sv-metric-card">
                ...
                <div style="display:flex; justify-content:space-between; align-items:flex-end;">
                    <div>
                        <div class="sv-metric-value">{sv_day_pl_aed_str}</div>
                    </div>
                    <div style="text-align:right;">
                        <div class="sv-metric-secondary">{sv_day_pl_pct_str}</div>
                    </div>
                </div>
            </div>
            """,
        ...
        st.markdown(
            ...
            <div class="sv-metric-card">
                ...
                <div style="display:flex; justify-content:space-between; align-items:flex-end;">
                    <div>
                        <div class="sv-metric-value">{sv_total_pl_aed_str}</div>
                    </div>
                    <div style="text-align:right;">
                        <div class="sv-metric-secondary">{sv_total_pl_pct_str}</div>
                    </div>
                </div>
            </div>
            """,
        ...
        st.markdown(
            """<div style=\"font-family: 'Space Grotesk', system-ui, -apple-system, BlinkMacSystemFont, 'Segoe UI', sans-serif; color:#16233a; font-size:0.75rem; margin:4px 0;\">Today's Gains – Sae</div>""",
            unsafe_allow_html=True,
        )
