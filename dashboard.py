...
index 9a68596885354bb005442699adc8b801fc822242..fe7133f714896801f8866cead2e84edf46ff9c52 100644
--- a/dashboard.py
+++ b/dashboard.py
@@ -1,138 +1,213 @@
...
@@ -176,189 +251,256 @@ if hist_data is not None:
...
+                st.markdown(f"<div style='border:1px solid #1f2d44; color:{COLOR_NEUTRAL}; padding:8px; border-radius:4px; margin-bottom:8px; background:#111b2c; font-size:0.9rem'>{a}</div>", unsafe_allow_html=True)
 ...
 with tab_positions:
     ...
     # FILTER STRIP
     with st.container():
@@ -392,105 +534,118 @@ with tab_positions:
         # Display Table
         st.dataframe(
             filtered_df,
             use_container_width=True,
